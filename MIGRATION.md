...
This document provides guidance for contributors migrating from the static HTML version to the React + TypeScript version of BetterSantaMaria.org.

## Overview

BetterSantaMaria.org now has two versions:
