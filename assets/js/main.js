/* Better Santa Maria - Main JavaScript */
...
function showInstallBanner() {
  ...
  banner.innerHTML =
    ...
    '<span>Install BetterSantaMaria for quick access to services.</span>' +
    '</div>' +
    '<div class="pwa-install-actions">' +
    '<button class="pwa-install-btn" aria-label="Install BetterSantaMaria app">Install</button>' +
