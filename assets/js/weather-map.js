/**
 * Weather & Map Section for Better Santa Maria Homepage
 * Displays real-time weather data and interactive map of Santa Maria, Bulacan
...
(function () {
  ...
  const WeatherService = {
    CACHE_KEY: 'santamaria_weather_cache',
  ...
  const WeatherUI = {
    render(container, data) {
      ...
      try {
        ...
        container.innerHTML = `
                <div class="weather-widget" role="region" aria-label="Current weather in Santa Maria">
                    <div class="weather-current">
                        ...
                        <div class="weather-current-info">
                            ...
                            <div class="weather-current-location">
                                <i class="bi bi-geo-alt" aria-hidden="true"></i> Santa Maria, Bulacan
                            </div>
                        </div>
                    </div>
  ...
  // ============================================================================
  const MapComponent = {
    SANTAMARIA_CENTER: [14.8197, 120.9610],
    DEFAULT_ZOOM: 14,
    map: null,
    ...
    initLeaflet(container) {
      try {
        ...
        // Add marker
        const marker = L.marker(this.SANTAMARIA_CENTER).addTo(this.map);
        marker.bindPopup('<strong>Santa Maria Municipal Hall</strong><br>Bulacan 3022');
