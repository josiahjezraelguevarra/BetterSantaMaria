...
const translations: Record<string, Record<string, string>> = {
  en: {
    ...
    // Appointment CTA
    'appointment-cta-heading': "Enhancing Appointment Services of LGU Santa Maria Mayor's Office",
    ...
    // Hero Section
    'hero-welcome': 'Welcome to BetterSantaMaria.org',
    'hero-subtitle':
      'Access government services, information, and resources for the people of Santa Maria, Bulacan.',
    ...
    'services-subtitle': 'Browse all services offered by the Municipality of Santa Maria',
    ...
    'health-section-hospitals': 'Hospitals in Santa Maria',
    'health-section-mho': 'Municipal Health Office',
    'health-section-bhs': 'Barangay Health Stations',
    'health-bhs-subtitle': '22 Barangay Health Stations/Centers serving all barangays of Santa Maria',
    'health-mho-title': 'Santa Maria Municipal Health Office',
    'health-mho-desc':
    ...
    'ord-page-desc': 'Municipal ordinances enacted by the Sangguniang Bayan ng Santa Maria',
    ...
    'ord-2025-subtitle': 'Official ordinances enacted by the Sangguniang Bayan ng Santa Maria in 2025',
    ...
    'reso-page-desc': 'Resolutions passed by the Sangguniang Bayan ng Santa Maria',
    ...
    'reso-2026-subtitle': 'Official resolutions passed by the Sangguniang Bayan ng Santa Maria in 2026',
    'reso-2025-title': '2025 Resolutions',
    'reso-2025-subtitle': 'Official resolutions passed by the Sangguniang Bayan ng Santa Maria in 2025',
    ...
    'biz-page-desc': 'Permits, licenses, and support for businesses in Santa Maria',
    ...
    // Homepage - Stats
    'stats-at-a-glance': 'Santa Maria at a Glance',
    ...
    'weather-map-title': 'Weather and Map of Santa Maria',
    'weather-mainly-clear': 'Mainly clear',
    'weather-location': 'Santa Maria, Bulacan',

    // Homepage - History
    'history-title': 'Brief History of Santa Maria',
    'history-1760':
    ...
    'history-1889':
      'Renamed Santa Maria in honor of Governor General Ramon Santa Maria y Llanderal. The town was redeveloped by Father Juan Villaverde with 14 parallel wide streets, each 20 meters wide, forming 100 square blocks.',
    'history-1957':
      "The barrios of Ibung and Bintawan were separated to form the town of Ibung, later renamed as Villaverde. Santa Maria's land area was reduced to 13,980 hectares.",
    'history-once-largest-title': 'Once the Largest',
    'history-once-largest-desc':
      'Santa Maria was the largest municipality in the province until Caliat and Bintawan were separated to become Quezon and Villaverde respectively.',
    ...
    'news-market-desc':
      'The renovated wing of the Santa Maria Public Market is now open to vendors and the public.',
    ...
    // Homepage - Quiz CTA
    'quiz-title': 'Santa Maria Quiz',
    'quiz-subtitle': 'How well do you know Santa Maria, Bulacan?',
    'quiz-description':
    ...
    'footer-lgu-portal': 'Official LGU Santa Maria Portal',
    'footer-sb': 'Sangguniang Bayan',
    'footer-lgu-facebook': 'LGU Santa Maria Facebook',
    'footer-blgf': 'BLGF Portal',
    'footer-cmci': 'CMCI DTI Portal',
    'footer-cost': 'Cost to the People of Santa Maria =',
    'footer-volunteer': 'Volunteer with us',
    'footer-contribute': 'Contribute code with us',
    'footer-copyright-text': 'BetterSantaMaria.org',
  ...
  fil: {
    ...
    'appointment-cta-heading':
      'Pagpapahusay ng Serbisyo sa Appointment ng Opisina ng Alkalde ng LGU Santa Maria',
    ...
    // Hero Section
    'hero-welcome': 'Maligayang Pagdating sa BetterSantaMaria.org',
    'hero-subtitle':
      'I-access ang mga serbisyo ng pamahalaan, impormasyon, at mga mapagkukunan para sa mga mamamayan ng Santa Maria, Bulacan.',
    ...
    'services-subtitle': 'Tingnan ang lahat ng serbisyong inaalok ng Munisipalidad ng Santa Maria',
    ...
    'health-section-hospitals': 'Mga Ospital sa Santa Maria',
    'health-section-mho': 'Opisina ng Kalusugan ng Munisipalidad',
    'health-section-bhs': 'Mga Barangay Health Station',
    'health-bhs-subtitle':
      '22 Barangay Health Stations/Centers na naglilingkod sa lahat ng barangay ng Santa Maria',
    'health-mho-title': 'Opisina ng Kalusugan ng Munisipalidad ng Santa Maria',
    'health-mho-desc':
    ...
    'ord-page-desc': 'Mga ordinansang ipinasa ng Sangguniang Bayan ng Santa Maria',
    ...
    'ord-2025-subtitle':
      'Mga opisyal na ordinansang ipinasa ng Sangguniang Bayan ng Santa Maria sa 2025',
    ...
    'reso-page-desc': 'Mga resolusyong ipinasa ng Sangguniang Bayan ng Santa Maria',
    ...
    'reso-2026-subtitle':
      'Mga opisyal na resolusyong ipinasa ng Sangguniang Bayan ng Santa Maria sa 2026',
    'reso-2025-title': 'Mga Resolusyon ng 2025',
    'reso-2025-subtitle':
      'Mga opisyal na resolusyong ipinasa ng Sangguniang Bayan ng Santa Maria sa 2025',
    ...
    'biz-page-desc': 'Mga permit, lisensya, at suporta para sa mga negosyo sa Santa Maria',
    ...
    // Homepage - Stats
    'stats-at-a-glance': 'Isang Tingin sa Santa Maria',
    ...
    // Homepage - Weather & Map
    'weather-map-title': 'Panahon at Mapa ng Santa Maria',
    'weather-mainly-clear': 'Halos maaliwalas',
    'weather-location': 'Santa Maria, Bulacan',

    // Homepage - History
    'history-title': 'Maikling Kasaysayan ng Santa Maria',
    'history-1760':
    ...
    'history-1889':
      'Pinalitan ang pangalan ng Santa Maria bilang parangal kay Gobernador Heneral Ramon Santa Maria y Llanderal. Ang bayan ay muling binuo ni Padre Juan Villaverde na may 14 na magkakahanay na malapad na kalye, bawat isa ay 20 metro ang lapad, na bumubuo ng 100 parisukat na bloke.',
    'history-1957':
      'Ang mga baryo ng Ibung at Bintawan ay pinaghiwalay upang bumuo ng bayan ng Ibung, na kalaunan ay pinalitan ng pangalang Villaverde. Ang lawak ng lupa ng Santa Maria ay nabawasan sa 13,980 ektarya.',
    'history-once-largest-title': 'Dating Pinakamalaki',
    'history-once-largest-desc':
      'Ang Santa Maria ang pinakamalaking munisipalidad sa probinsya hanggang sa pinaghiwalay ang Caliat at Bintawan upang maging Quezon at Villaverde.',
    ...
    'news-market-desc':
      'Ang na-renovate na wing ng Pampublikong Palengke ng Santa Maria ay bukas na sa mga nagtitinda at publiko.',
    ...
    // Homepage - Quiz CTA
    'quiz-title': 'Santa Maria Quiz',
    'quiz-subtitle': 'Gaano mo kakilala ang Santa Maria, Bulacan?',
    'quiz-description':
    ...
    'footer-lgu-portal': 'Opisyal na Portal ng LGU Santa Maria',
    'footer-sb': 'Sangguniang Bayan',
    'footer-lgu-facebook': 'LGU Santa Maria Facebook',
    'footer-blgf': 'BLGF Portal',
    'footer-cmci': 'CMCI DTI Portal',
    'footer-cost': 'Gastos sa mga Tao ng Santa Maria =',
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    const savedLang = localStorage.getItem('bettersantamaria_lang') as Language;
  ...
  const setLanguage = (lang: Language) => {
    ...
    localStorage.setItem('bettersantamaria_lang', lang);
  };
